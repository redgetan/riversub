...
function subtitleVideo(url, options) {
  ...
  if (url.match(/youtu\.?be.com/) || url.match(/vimeo.com/) || url.match(/nicovideo.jp/) || url.match(/tvcast.naver.com/)) {
  } else {
    throw "Only youtube, naver, nicovideo, and vimeo urls are allowed";
  }
